...
describe OAuth::Signature do
  ...
  describe "base string" do
    it "computes without port in host" do
      request = HTTP::Request.new HTTP::Methods::POST, "/some/path"
  ...
  it "does twitter sample" do
    request = HTTP::Request.new HTTP::Methods::POST, "/1/statuses/update.json?include_entities=true", body: "status=Hello%20Ladies%20%2b%20Gentlemen%2c%20a%20signed%20OAuth%20request%21"
